...
type SIZE_TYPES = 'xs' | 'xs-max' | 'sm' | 'sm-max' | 'smd-max' | 'smd' | 'md' | 'md-max' | 'lg' | 'lg-max' | 'xl';

const sizes = {
    xs: `${theme.breakpoints.xs}px`,
    'xs-max': `${theme.breakpoints.sm - 1}px`,
    sm: `${theme.breakpoints.sm}px`,
    'sm-max': `${theme.breakpoints.smd - 1}px`,
    smd: `${theme.breakpoints.smd}px`,
    'smd-max': `${theme.breakpoints.md}px`,
